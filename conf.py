...
html_theme_options = {
    ...
    'navbar_title': "A Practical Introduction to Databases",
...
html_title = 'A Practical Introduction to Databases'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='A Practical Introduction to Databases'
...
html_static_path = runestone_static_dirs() + ['_sources/_static']
